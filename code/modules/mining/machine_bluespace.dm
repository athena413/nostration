...
/datum/design/bluemine
	...
	materials = list(/datum/material/gold = 500, /datum/material/silver = 500, /datum/material/bluespace = 500)
...
/obj/machinery/mineral/bluespace_miner
	...
	var/list/ores = list(/datum/material/iron = 600, /datum/material/gold = 600, /datum/material/plasma = 400,  /datum/material/silver = 400, /datum/material/gold = 250, /datum/material/titanium = 250, /datum/material/uranium = 250, /datum/material/diamond = 90, /datum/material/bluespace = 90)
